...
public class GamePlay implements Runnable{
	...
	private void call() throws IOException, InterruptedException {
		...
		JPanel bg1 = new BackGround(0, 0, "/ThreadRunImages/cplusplus.png" ,frameWidth, 3623, p1, 1, gerador, powerUps, mem);
		bg1.setBounds(0, 0, 370, 720);
		frame.getContentPane().add(bg1);
		
		JPanel bg2 = new BackGround(0, 0, "/ThreadRunImages/java.png" ,frameWidth, 3623, p2, 2, gerador, powerUps,mem);
		bg2.setBounds(370, 0, 370, 720);
		frame.getContentPane().add(bg2);
		
		JPanel bg3 = new BackGround(0, 0, "/ThreadRunImages/python.png" ,frameWidth, 3623, p3,  3, gerador, powerUps,mem);
